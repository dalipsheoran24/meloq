...
class VideoMachinePage extends StatefulWidget {
  const VideoMachinePage({Key? key}) : super(key: key);

  @override
  _VideoMachinePageState createState() => _VideoMachinePageState();
}

class _VideoMachinePageState extends State<VideoMachinePage> {
                              ...
                              child: InkWell(
                                        ...
                                        children: [Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                  image: NetworkImage(
                                                      "https://dazzingshadow.com/meloq/img/product_images/"+productiveVideoList[index].image!),
                                                  fit: BoxFit.fill),
                                              shape: BoxShape.rectangle),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.only(top: 30,left: 55),
                                          child: Icon(Icons.slow_motion_video_sharp,size: 30,),
                                        )
                                        ],
                                      ...
                                      Container(
                                        ...
                                        child: Center(
                                          child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text(
                                              productiveVideoList[index].title!,
                                  ...
                                  onTap: () {
                                    Navigator.pushNamed(context, Routes.OPENVIDEO,
                                        arguments: productiveVideoList[index]);}
                              ),
                            ));
                      }),
                ),
